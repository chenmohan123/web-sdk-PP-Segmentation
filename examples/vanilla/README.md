...
对应本地包 `web-sdk-pp-segmentation@0.1.0-alpha.0`。可运行入口为 [index.html](index.html) 与 [main.ts](main.ts)，通过构建后的公共 SDK 实现选图、WASM/Worker 分割、ROI 叠加、错误反馈和资源释放，不依赖 React。
