...
[src/types.ts](../../src/types.ts) is the type reference. The runtime in `web-sdk-pp-segmentation@0.1.0-alpha.0` is independent of UI frameworks. Only the fixed four-output PP-YOLOE_seg_s 640 FP32 contract has been exercised.
